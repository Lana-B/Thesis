...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% new page right, blank left page without headings
%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\xcleardoublepage}
{{\pagestyle{empty}\cleardoublepage}}

%%%%%%%%%%%%%%%%%%%%%%%%%%
% table column types (needs colortbl)
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% lower text
%%%%%%%%%%%%%%%%%%%%%%%%%%
% S\tl{0} puts the 0 under the s S (without math mode)
\makeatletter
...
\def\gsf{0.9}
% graphic, 
% 3 parameters: file, label, caption
\newcommand{\Fig}[3]{%
\begin{figure}[tbh] %
...
% graphic, scaled, position
% 5 parameters: position, width (0 to 1.0), file, label, caption
\newcommand{\Figs}[5]{%
\begin{figure}[#1]%
\begin{center}
...
%% graphic, position, free parameter for 
% includegraphics
%% 5 parameter: position, options, file, label, caption
\newcommand{\Figo}[5]{%
\begin{figure}[#1]%
\begin{center}
...
%%
% commads from J Krieger:
% http://www.jkrieger.de/tools/latex/jkcommandstex.html
%%
