...
In this model sgluons are top-philic, ie. they are only allowed to decay to \ttbar or to two gluons. The benchmark values for the couplings and theory cut-off scale are:
% \begin{equation}
\begin{align}
...
The simplified model discussed is consistent with an enhancement in the production of \tttt final states in proton-proton collisions.

[talk about plot] 

~\cite{GoncalvesNetto:2012nt,Degrande:2014sta}. 
