...
\begin{figure}[ht!]
\centering
    \includegraphics[width=0.49\textwidth]{images/Run1/ptrw_xcheck2.pdf}
    \includegraphics[width=0.49\textwidth]{images/Run1/NomTune_Mu_Log2.pdf}\\
        \includegraphics[width=0.7\textwidth]{images/Run1/PDF_uncertainty_mu2.pdf}
...
\chapter{Cross checks on \runtwo $\boldsymbol{\tttt}$ analysis at $\boldsymbol{\sqrt{s}=13}$~TeV \label{app:run1}}
...
\begin{figure}[ht!]
    ...
    \caption{The BDT output distributions for the Event-level BDT for data and simulation in the $\mu$ + jets channel (left) and e + jets channel (right) are shown for the 6 \njets and $\geq4$ \nMtags category.}
...
\begin{figure}[ht!]
    ...
    \caption{The BDT output distributions for the Event-level BDT for data and simulation in the $\mu$ + jets channel (left) and e + jets channel (left) are shown for the 7 \njets and 2 \nMtags category.}
...
\begin{figure}[ht!]
    ...
    \caption{The BDT output distributions for the Event-level BDT for data and simulation in the $\mu$ + jets channel (left) and e + jets channel (right) are shown for the 7 \njets and $\geq4$ \nMtags category.}
...
\begin{figure}[ht!]
    ...
    \caption{The BDT output distributions for the Event-level BDT for data and simulation in the $\mu$ + jets channel (left) and $e$ + jets channel (left) are shown for the 8 \njets and 2 \nMtags category.}
...
\begin{figure}[ht!]
    ...
    \caption{The BDT output distributions for the Event-level BDT for data and simulation in the $\mu$ + jets channel (left) and $e$ + jets channel (right) are shown for the 8 \njets and $\geq4$ \nMtags category.}
